  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <a href="applied-jobs.php" class="btn btn-success">Applied Internships</a>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="table-responsive">
            <h2 class="text-center">Active Internships</h2>
              ...
              <tbody>
                <?php 
                  ...
                  if($result->num_rows > 0) {
                    ...
                    {
                      $sql1 = "SELECT * FROM apply_intern_post WHERE id_user='$_SESSION[id_user]' AND id_jobpost='$row[id_jobpost]'";
